...
public class dummy : MonoBehaviour {
	...
	public static dummy Instance { set; get; }
	private int d = 0;
	...
	public Text t;
	public AudioClip movement_clip, cutting_clip;
...
//		black_turn = false;
	...
	void Update(){
		...
		if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Began) {
			...
			obj = MouseRaycast (Input.mousePosition);
				...
				case "Board": // For Movement
					...
					if (selected) {
						if (Input.GetMouseButtonDown(0)) {
							destination = MouseRaycast (Input.mousePosition);
